...
},
{
  ...
  "body": " Diffie-Hellman key exchange   Alice and Bob wish to share a key over an insecure communication channel. The Diffie-Hellman key exchange accomplishes this as follows.   Public  Alice and Bob choose publicly on a prime and a primitive root modulo .    Private  Alice chooses a random integer exponent , and Bob chooses a random integer exponent . These exponents are kept private.    Exchange  Alice computes and sends this value to Bob; Bob computes and sends this value to Alice.    Shared key  Alice and Bob use their private exponents and to compute the shared key .      "
},
{
  "id": "d_discrete_log",
  "level": "2",
...
},
{
  ...
  "body": " Discrete log problem   Let be a prime integer, let be a primitive root, and let . Find an integer such that , or equivalently, such that . In other words, compute .   "
},
{
  ...
  "body": " Diffie-Hellman problem   Let be a prime integer, and let be a primitive root. Given elements and of , compute the element .   "
},
{
  "id": "ss_diffie_hellman-7",
  "level": "2",
  "url": "s_public_key.html#ss_diffie_hellman-7",
  "type": "Remark",
  "number": "1.19.6",
...
{
  "id": "ss_diffie_hellman-8",
  "level": "2",
  "url": "s_public_key.html#ss_diffie_hellman-8",
  "type": "Sage example",
  "number": "9",

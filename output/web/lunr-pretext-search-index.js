...
},
{
  ...
  "level": "2",
  "url": "s_primitive_roots.html#d_order_modular_unit",
  "type": "Definition",
  "number": "1.2.1",
  "title": "Order of a modular unit.",
  "body": " Order of a modular unit    order of element    Let be a positive integer. Given an element , its order is the smallest positive integer such that .  Similarly, given an integer that is relatively prime to , the order of modulo is the smallest positive integer such that .   "
},
{
  "id": "ss_order_primitive_roots-5",
  "level": "2",
  "url": "s_primitive_roots.html#ss_order_primitive_roots-5",
  "type": "Remark",
  "number": "1.2.2",
...
},
{
  "id": "prop_order_mod_n",
  "level": "2",
  "url": "s_primitive_roots.html#prop_order_mod_n",
  "type": "Proposition",
  "number": "1.2.3",
  "title": "Order of modular units.",
  "body": " Order of modular units   Let be a positive integer, let , and let .   For all integers , if and only if .     if and only if .    We have , and this set has cardinality ( , it contains exactly distinct elements).     for all integers .          First assume that , so that for some . We then have , as desired. Conversely, assume and write where , as in the division algorithm. Since , and since is the smallest positive integer satisfying , we must have , and thus .    We have .    Since if and only if , and since form a complete set of residues modulo , we have , and these powers of are all distinct. Thus the set has cardinality .    Let . We will show that is the smallest positive integer such that , and thus that .  First observe that , since . Now assume that is a positive integer satisfying . It follows that . But then . Since and are relatively prime, it follows that , and hence that , since and are positive. This proves is the smallest positive integer such that , and thus that .      "
},
{
  "id": "d_cyclic_group",
  "level": "2",
  "url": "s_primitive_roots.html#d_cyclic_group",
  "type": "Definition",
  "number": "1.2.4",
  "title": "Primitive root.",
  "body": " Primitive root   Let be a positive integer, and let . The cyclic group generated by , denoted , is the set of all integer powers of : , , where .  A primitive root (or cyclic generator ) of is an element satisfying .   "
},
{
  "id": "eg_primitive_roots",
  "level": "2",
  "url": "s_primitive_roots.html#eg_primitive_roots",
  "type": "Example",
  "number": "1.2.5",
  "title": "Primitive roots.",
  "body": " Primitive roots   Decide for the given modulus whether has a primitive root.                        "
},
{
  "id": "d_polynomials",
  "level": "2",
  ...
  "body": " Polynomials over a ring   Let be either , , , or for some positive integer . A polynomial over in the indeterminate (or variable) is a formal expression of the form , where is a nonnegative integer and for all . We call the coefficients of . The polynomial is nonzero if for some , and zero otherwise. The degree of a nonzero polynomial , denoted , is the largest positive integer such that the -th coefficient of is nonzero.  Two nonzero polynomial and with and are equal, written if and for all .  Given a polynomial and an element , the evaluation of at is the element defined as . In this manner, the polynomial defines a function . An element is a root of if .  Lastly, addition and multiplication of polynomials are defined as usual. In particular, given and , we have , where for all .   "
},
{

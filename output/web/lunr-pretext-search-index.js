...
},
{
  ...
  "number": "1.16.7",
  "title": "Unit group of real quadratic extensions.",
  "body": " Unit group of real quadratic extensions   Let be a positive squarefree integer, let , and let and be elements of . We have if and only if .  As a result, the fundamental unit described in is the element of with minimal first coefficient .    Proof on its way.   "
},
{
  "id": "s_pells_eqn",
  "level": "1",
